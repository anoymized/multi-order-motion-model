        ...
        for index in range(image_batch.size(0)):
            for mask_idx, pixel in enumerate(mask_pixel[index]):
                ...
                if types == 1:  # random noise
                    ...
                    temple = Theta(image_batch[index], mask)

                elif types == 10:  # enhance the contrast
                    temple = local_process_image(image_batch[index], mask, processor=enhance_contrast_processor)
