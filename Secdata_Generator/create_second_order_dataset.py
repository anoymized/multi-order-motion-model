...
config_dict = {"data": {"at_cfg": {"cj": True,
                        ...
                        "root_self_render": "/home/4TSSD/opticalflowdataset/sec/human/select",
                        "root_self_dynamic": "/home/4TSSD/opticalflowdataset/sec/dynamic",
                        "run_at": True,
                        "test_shape": [448, 1024],
...
def create_second_order_dataset():
    ...
    # train_set = SelfRender(cfg.root_self_dynamic, n_frames=cfg.train_n_frames,
